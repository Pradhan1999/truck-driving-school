...
export function TimelineDotIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="22" height="22" viewBox="0 0 31 29" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
      ...
      />
      <ellipse cx="15.5" cy="14.413" rx="5.88363" ry="6.5625" transform="rotate(-90 15.5 14.413)" fill="#2A50ED" />
    </svg>
  );
}
